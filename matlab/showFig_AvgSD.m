...
function showFig_AvgSD(figName, winT, avgTr, stdT, NPointsWinNegLocalT, ...
    maxIPSC, maxIPSCNN, minIPSC, minIPSCNN, maxNegIPSC, maxNegIPSCNN, ...
    maxPosIPSC, maxPosIPSCNN, minNegIPSC, minNegIPSCNN, minPosIPSC, ...
    minPosIPSCNN, IntervalNeg2T, IntervalPos2T, CalcMinT, str0T, strT, ...
    xlabel1T, ylabel1T, nameHNsigT)
...
disp(['in showFig\_AvgSD idxXright = ' num2str(idxXright) ...
    '... idxXleft = ' num2str(idxXleft)])
