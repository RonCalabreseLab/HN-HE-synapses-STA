function plotSpkTrigAvgCloudOLD(winT, traces, fileName, sta_methodT, ...
...
%%% fig 2: cloud and avg
showFig_CloudAvg('SpkTrigAvg Cloud', sta_methodT, traces, winT, avgTr, ...
...
showFig_CloudAvgSD('SpkTrigAvg Cloud', sta_methodT, traces, winT, avgTr, ...
...
%%% fig 4: avg
showFig_Avg('SpkTrigAvg Cloud', winT, avgTr, NPointsWinNegLocalT, maxIPSC, ...
...
showFig_AvgSD('SpkTrigAvg Cloud', winT, avgTr, stdTrT, NPointsWinNegLocalT, ...
    maxIPSC, maxIPSCNN, minIPSC, minIPSCNN, maxNegIPSC, maxNegIPSCNN, ...
    maxPosIPSC, maxPosIPSCNN, minNegIPSC, minNegIPSCNN, minPosIPSC, ...
