% Function to pop up a window and ask for configuration parameters.
function [sta_met, invCorrTrace, invTriggTrace, nDisFirst, nDisLast, ...
    ...
    fontS, trPerPage, noBurStat, printNext, filterData, subPreSpikeData] = ...
    askWinSTA_1_global(sigName)

  % TODO: all of these return values should be set into a configuration
  % struct such that it's easy to pass around
...
% CG changed these per Angela's request on 2017/05/04
spikeSub = 0; 
spikeAdd = 0;
...
figGlob = figure('position', [100 100 900 600],'Name','Input Globals',...
    ...
    set(gca,'Visible','off');    
    hold on;
    pFig = uipanel('Parent', figGlob,'Title', ...
    ...
    % No space left at the end, so squeeze it here
    filterCheckbox = ...
        uicontrol('Parent', pGen, 'Style', 'checkbox', ...
                  'String', 'High-pass filter current data (Cengiz)', ...
                  'Value', filterData, ...
                  'Max', 1, 'Min', 0, ...
                  'Callback',{@filter_callback}, ...
                  'Units','normalized',...
                  'Position',[.21 .27 .79 .05]);
    subPreSpikeCheckbox = ...
        uicontrol('Parent', pGen, 'Style', 'checkbox', ...
                  'String', 'Subtract value at presyn spike time (Cengiz)', ...
                  'Value', subPreSpikeData, ...
                  'Max', 1, 'Min', 0, ...
                  'Callback',{@subPreSpike_callback}, ...
                  'Units','normalized',...
                  'Position',[.21 .23 .79 .05]);
    ...
    spikeSubEdit = uicontrol('Parent',pGen,...
        'Style','edit','String',num2str(spikeSub),...
        'Units','normalized',...
        'Enable','on',...
    ...
    spikeAddEdit = uicontrol('Parent',pGen,...
        'Style','edit','String',num2str(spikeAdd),...
        'Units','normalized',...
        'Enable','on',...
    ...
    function filter_callback(hObject,eventdata)  
      filterData = hObject.Value
    end  
    function subPreSpike_callback(hObject,eventdata)  
      subPreSpikeData = hObject.Value
    end  
