...
% changed saved spikes file to 6 digits precision and with index, so no
% need for rounding
...
idxSPK = dataSpkRem(idx, 3);            % index of spike
newV = vv(idxSPK);                      % voltage at spike
trHE = dt(idxSPK,3);                    % HE voltage at spike
